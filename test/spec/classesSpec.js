...
describe("Classes", function() {
  ...
  describe("Manager", function() {
    ...
    it("can hire new employees", function() {
      ...
      emp.hire(
        new Employee("Ballin", "BAnderson", "Ballin@BallinBallin.com", 22)
      );
    ...
    it("can fire new employees", function() {
      ...
      emp.hire(
        new Employee("Ballin0", "BAnderson", "Ballin@BallinBallin.com", 22)
      );
      emp.hire(
        new Employee("Ballin1", "BAnderson", "Ballin@BallinBallin.com", 22)
      );
      emp.hire(
        new Employee("Ballin2", "BAnderson", "Ballin@BallinBallin.com", 22)
      );
      emp.fire(1);
  ...
  describe("ProgressiveManager", function() {
    ...
    it("sets all properties in the constructor and title and bonus", function() {
      let emp = new ProgressiveManager(
        "Dallin",
        "Anderson",
        "Dallin@DallinDallin.com",
        25
  ...
  describe("Machine", function() {
    ...
    it("can update wear and tear after fixes and reboot", function() {
      ...
      expect(machine.wear_and_tear_count).toEqual(
        100,
        "wear_and_tear_count should be 100 until function returned by machine.reboot() is executed."
      );
      expect(machine.needs_reboot).toBe(
        true,
        "needs_reboot should be true until function returned by machine.reboot() is executed."
      );
